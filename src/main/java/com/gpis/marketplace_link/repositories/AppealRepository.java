...
public interface AppealRepository extends JpaRepository<Appeal,Long> {
    ...
    @Query("""
        ...
        JOIN FETCH i.publication p
        JOIN FETCH a.seller s
        WHERE a.newModerator.id = :moderatorId
        AND a.status = com.gpis.marketplace_link.enums.AppealStatus.ASSIGNED
    """)
    List<Appeal> findAllAssignedByModerator(@Param("moderatorId") Long moderatorId);
